  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col gap-4 p-6 ${featured ? 'flex-1' : ''}`}>
        ...
        {/* Descripción */}
        <p className="font-body text-dust" style={{ fontSize: '0.87rem', lineHeight: 1.75, fontWeight: 500 }}>
          {project.description}
        </p>
        ...
        <button
          ...
          className="flex items-center gap-2 font-body text-dust/60 hover:text-star transition-colors self-start"
        ...
        >
          ...
          {expanded ? 'Ocultar detalles' : 'Ver problema y aprendizaje'}
        </button>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1.5" style={{ color }}>
        {icon}
        <span className="font-body" style={{ fontSize: '0.78rem', fontWeight: 600 }}>
          {label}
        </span>
      </div>
      <p className="font-body text-dust" style={{ fontSize: '0.85rem', lineHeight: 1.75, fontWeight: 500 }}>
        {text}
      </p>
    </div>
  )
